...
public class CustomActionSheetDialog extends Dialog {

    public CustomActionSheetDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public CustomActionSheetDialog create() {
            final CustomActionSheetDialog dialog = new CustomActionSheetDialog(p.context, shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            ...
            if (hasTitle) {
                ...
                tTitle.setBackgroundResource(R.drawable.custom_dialog_selection_selector_top);
            ...
            for (int i = 0; i < p.menuList.size(); i++) {
                ...
                int backgroundResId = R.drawable.custom_dialog_selection_selector_center;
                if (p.menuList.size() > 1) {
                    if (i == 0) {
                        if (hasTitle) {
                            backgroundResId = R.drawable.custom_dialog_selection_selector_center;
                        } else {
                            backgroundResId = R.drawable.custom_dialog_selection_selector_top;
                        }
                    } else if (i == p.menuList.size() - 1) {
                        backgroundResId = R.drawable.custom_dialog_selection_selector_bottom;
                    }
                } else if (p.menuList.size() == 1) {
                    backgroundResId = R.drawable.custom_dialog_selection_selector_singleton;
                }
